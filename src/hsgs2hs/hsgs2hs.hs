...
globalEnv = Env{
    gsvars = Map.fromList [
        ...
        ("get-implicit", (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_env_get_implicit", HSVar "gstype_checker_env_get_implicit")),
        ("get-pos", (Set.singleton $ HSIVar "GSI.Parser" "gsparser_getPos", HSVar "gsparser_getPos")),
        ("get-type", (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_env_get_type", HSVar "gstype_checker_env_get_type")),
