...
globalEnv = Env{
    gsvars = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("analyze-impM", "GSI.StdLib", "gsanalyzeImpM"),
        ...
        ("category.monoidal", "GSDL.AST", "gscategory_monoidal"),
        ...
        ("expr.monoidal-pat", "GSDL.AST", "gsexpr_monoidal_pat"),
        ...
        ("gsbcnonmonoidalpattern", "GSI.GSI", "gsigsbcnonmonoidalpattern"),
    ...
    gsviews = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("category.monoidal", "GSDL.AST", "gscategory_monoidal_view"),
        ...
        ("expr.monoidal-pat", "GSDL.AST", "gsexpr_monoidal_pat_view"),
