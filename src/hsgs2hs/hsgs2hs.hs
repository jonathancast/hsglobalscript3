...
globalEnv = Env{
    gsvars = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("consume.here", "GSDL.AST", "gsconsume_here"),
        ...
        ("hsgs.compiler.supply.env.here.get", "GSDL.HSGS.Compiler", "gshsgs_compiler_supply_env_here_get"),
        ("hsgs.compiler.supply.env.here.insert", "GSDL.HSGS.Compiler", "gshsgs_compiler_supply_env_here_insert"),
    ...
    gsviews = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("consume.here", "GSDL.AST", "gsconsume_here_view"),
