...
globalEnv = Env{
    gsvars = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("hsgs.compile-value", "GSDL.HSGS.Compile", "gshsgs_compile_value"),
        ...
        ("hsgs.compiler.env.generator.modify", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_generator_modify"),
        ("hsgs.compiler.env.supply.get", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_supply_get"),
        ("hsgs.compiler.env.supply.modify", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_supply_modify"),
        ("hsgs.compiler.env.supply.monad.insert", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_supply_monad_insert"),
        ("hsgs.compiler.env.unary.get", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_unary_get"),
        ("hsgs.compiler.env.unary.modify", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_unary_modify"),
        ...
        ("hsgs.compiler.env.view.get", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_view_get"),
        ("hsgs.compiler.env.view.insert", "GSDL.HSGS.Compiler", "gshsgs_compiler_env_view_insert"),
        ("hsgs.compiler.global-env", "GSDL.HSGS.GlobalEnv", "gshsgs_compiler_global_env"),
        ("hsgs.compiler.supply.env.empty", "GSDL.HSGS.Compiler", "gshsgs_compiler_supply_env_empty"),
        ("hsgs.compiler.supply.env.monad.get", "GSDL.HSGS.Compiler", "gshsgs_compiler_supply_env_monad_get"),
        ("hsgs.compiler.supply.env.monad.insert", "GSDL.HSGS.Compiler", "gshsgs_compiler_supply_env_monad_insert"),
