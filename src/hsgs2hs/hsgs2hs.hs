...
globalEnv = Env{
    gsvars = Map.fromList [
        ...
        ("expr.app", (Set.singleton $ HSIVar "GSDL.Syntax" "gsexpr_app", HSVar "gsexpr_app")),
        ("expr.var", (Set.singleton $ HSIVar "GSDL.Syntax" "gsexpr_var", HSVar "gsexpr_var")),
        ("false", (Set.singleton $ HSIVar "GSI.Bool" "gsfalse", HSVar "gsfalse")),
        ("file.document", (Set.singleton $ HSIVar "GSDL.Syntax" "gsfileDocument", HSVar "gsfileDocument")),
        ...
        ("get-implicit", (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_get_implicit", HSVar "gstype_checker_get_implicit")),
        ("get-pos", (Set.singleton $ HSIVar "GSI.Parser" "gsparser_getPos", HSVar "gsparser_getPos")),
        ("get-type", (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_get_type", HSVar "gstype_checker_get_type")),
        ...
        ("implicit.here", (Set.singleton $ HSIVar "GSDL.Syntax" "gsimplicit_here", HSVar "gsimplicit_here")),
        ...
        ("kind.pointed", (Set.singleton $ HSIVar "GSDL.Syntax" "gskind_pointed", HSVar "gskind_pointed")),
        ...
        ("type-checker.env.empty",  (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_env_empty", HSVar "gstype_checker_env_empty")),
        ("type-checker.env.implicits.insert",  (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_env_implicits_insert", HSVar "gstype_checker_env_implicits_insert")),
        ("type-checker.env.type.insert",  (Set.singleton $ HSIVar "GSDL.TypeChecker" "gstype_checker_env_type_insert", HSVar "gstype_checker_env_type_insert")),
    ...
    gsviews = Map.fromList [
        ...
        ("arg.expr", (Set.singleton $ HSIVar "GSDL.Syntax" "gsarg_expr_view", HSVar "gsarg_expr_view")),
        ("arg.here", (Set.singleton $ HSIVar "GSDL.Syntax" "gsarg_here_view", HSVar "gsarg_here_view")),
        ("eq", (Set.singleton $ HSIVar "GSI.OrderTotal" "gsord_eq_view", HSVar "gsord_eq_view")),
        ("expr.app", (Set.singleton $ HSIVar "GSDL.Syntax" "gsexpr_app_view", HSVar "gsexpr_app_view")),
        ("expr.var", (Set.singleton $ HSIVar "GSDL.Syntax" "gsexpr_var_view", HSVar "gsexpr_var_view")),
        ("false", (Set.singleton $ HSIVar "GSI.Bool" "gsfalse_view", HSVar "gsfalse_view")),
        ("file.document", (Set.singleton $ HSIVar "GSDL.Syntax" "gsfileDocument_view", HSVar "gsfileDocument_view")),
