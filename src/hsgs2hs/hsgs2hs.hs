...
globalEnv = Env{
    gsvars = Map.fromList [
        ...
        ("analyzeM", (Set.singleton $ HSIVar "GSI.StdLib" "gsanalyzeM", HSVar "gsanalyzeM")),
        ...
        ("expr.structure-literal", (Set.singleton $ HSIVar "GSDL.AST" "gsexpr_structure_literal", HSVar "gsexpr_structure_literal")),
        ...
        ("pos.init", (Set.singleton $ HSIVar "GSI.Parser" "gspos_init", HSVar "gspos_init")),
