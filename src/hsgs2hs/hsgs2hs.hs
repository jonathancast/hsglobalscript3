...
globalEnv = Env{
    gsvars = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("dest-comp.imports", "GSDL.AST", "gsdest_comp_imports"),
        ("dest-comp.pos", "GSDL.AST", "gsdest_comp_pos"),
        ...
        ("source-comp.pos", "GSDL.AST", "gssource_comp_pos"),
    ...
    gsviews = Map.fromList $ map (\ (gsn, hsm, hsn) -> (gsn, (Set.singleton $ HSIVar hsm hsn, HSVar hsn))) $ [
        ...
        ("dest-comp.pos", "GSDL.AST", "gsdest_comp_pos_view"),
