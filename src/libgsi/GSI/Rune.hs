...
module GSI.Rune (gsisAsciiDigit, gsisLower, gsisSpace, gsrune_code_point, gsrune_from_code_point, gsrune_neq, gsruneEq) where

import Data.Char (isDigit, isLower, isSpace, chr, ord)
